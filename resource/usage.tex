...
\begin{verbatim}
    ...
    CMakeLists.txt
\end{verbatim}
\voidtest\ declares an alias target (\code{void\_test::void\_test}) which can be used as
...
this framework \bold{defines its own main function} -- everything in the following section assumes
